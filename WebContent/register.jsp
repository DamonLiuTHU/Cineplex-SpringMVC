...
<style>
   *{margin:0;padding:0;}
   ...
   .inputElem {width:100%;height:22px;line-height:22px;border:1px solid #ff4455;}
   .parentCls{width:30%;}
	...
	<div class="wrap">
		...
		<form class="" method="POST" action="register">
			<div class="parentCls">
				...
				<input type="text" class="inputElem" name="phone">
			</div>
    ...
    _renderHTML: function(cfg) {
        ...
        if(curIndex > -1){
            ...
            if(_cache.onlyFlag) {
                ...
                $('.auto-tip',cfg.parentNode).css({'position':'absolute','top':cfg.height+22,'width':'100%','left':0,
